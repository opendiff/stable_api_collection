...
module 
  class Engine
    ...
    def initialize(@description : String, @id : String, @name : String, @_type : String)
    end
    ...
    def valid?
      _type_validator = EnumAttributeValidator.new("String", ["AUDIO", "CLASSIFICATION", "PICTURE", "STORAGE", "TEXT", "VIDEO"])
    ...
    def hash
      [description, id, name, _type].hash
    end
