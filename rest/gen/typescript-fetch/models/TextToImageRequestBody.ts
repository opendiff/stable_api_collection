...
import type { TextPrompt } from './TextPrompt';
import {
    TextPromptFromJSON,
...
/**
 * Check if a given object implements the TextToImageRequestBody interface.
 */
export function instanceOfTextToImageRequestBody(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "textPrompts" in value;

    return isInstance;
}

export function TextToImageRequestBodyFromJSON(json: any): TextToImageRequestBody {
    return TextToImageRequestBodyFromJSONTyped(json, false);
}

export function TextToImageRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): TextToImageRequestBody {
...
export function TextToImageRequestBodyToJSON(value?: TextToImageRequestBody | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
