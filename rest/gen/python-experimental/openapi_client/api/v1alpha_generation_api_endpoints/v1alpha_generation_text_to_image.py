...
# body param
SchemaForRequestBodyApplicationJson = TextToImageRequestBody


request_body_text_to_image_request_body = api_client.RequestBody(
    content={
...
_path = '/v1alpha/generation/{engine_id}/text-to-image'
_method = 'POST'
_auth = [
...
class V1alphaGenerationTextToImage(api_client.Api):
    ...
    def v1alpha_generation_text_to_image(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_text_to_image_request_body.serialize(body, content_type)
