...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = V1alphaEnginesApi()
        api_instance.v1alpha_engines_list_engines  # this is an instance of the class Endpoint
        api_instance.v1alpha_engines_list_engines()  # this invokes api_instance.v1alpha_engines_list_engines.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.v1alpha_engines_list_engines.callable or self.callable in this class
