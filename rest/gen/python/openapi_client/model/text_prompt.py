...
class TextPrompt(ModelNormal):
    ...
    def _from_openapi_data(cls, text, *args, **kwargs):  # noqa: E501
        """TextPrompt - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            weight (float): Weight of the prompt (use negative numbers for negative prompts). [optional]  # noqa: E501
        """
