...
AccountResponseBody
#>
function Invoke-V1alphaUserAccount {
    [CmdletBinding()]
    Param (
        [Switch]
        $WithHttpInfo
    ...
    Process {
        'Calling method: Invoke-V1alphaUserAccount' | Write-Debug
        ...
        $LocalVarUri = '/v1alpha/user/account'
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "AccountResponseBody" `
...
BalanceResponseBody
#>
function Invoke-V1alphaUserBalance {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-V1alphaUserBalance' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/v1alpha/user/balance'
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "BalanceResponseBody" `
                                -IsBodyNullable $false
