...
* @version 0.1
*/
export default class V1alphaGenerationApi extends ApiClient {
    ...
    */
     ...
     * @return {Promise}
     */
    async v1alphaGenerationImageToImage(engineId, accept, initImage, options, opts) {
      opts = opts || {};
      let postBody = null;
     ...
     * @return {Promise}
     */
    async v1alphaGenerationMasking(engineId, accept, initImage, options, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'engineId' is set
      if (engineId === undefined || engineId === null) {
     ...
     * @return {Promise}
     */
    async v1alphaGenerationTextToImage(engineId, accept, textToImageRequestBody, opts) {
      opts = opts || {};
