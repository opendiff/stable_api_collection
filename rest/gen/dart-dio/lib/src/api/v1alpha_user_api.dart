...
class V1alphaUserApi {
  ...
  const V1alphaUserApi(this._dio, this._serializers);
  ...
  Future<Response<AccountResponseBody>> v1alphaUserAccount({ 
    ...
    final _path = r'/v1alpha/user/account';
    ...
    try {
      const _responseType = FullType(AccountResponseBody);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BalanceResponseBody>> v1alphaUserBalance({ 
    String? organization,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1alpha/user/balance';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
    ...
    try {
      const _responseType = FullType(BalanceResponseBody);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
