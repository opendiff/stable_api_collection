...
class V1alphaEnginesApi {
  ...
  const V1alphaEnginesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ListEnginesResponseBody] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<ListEnginesResponseBody>> v1alphaEnginesListEngines({ 
    String? organization,
    ...
    final _path = r'/v1alpha/engines/list';
    ...
    ListEnginesResponseBody _responseData;

    try {
      const _responseType = FullType(ListEnginesResponseBody);
    ...
    return Response<ListEnginesResponseBody>(
      data: _responseData,
