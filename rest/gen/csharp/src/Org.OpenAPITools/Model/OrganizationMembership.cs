...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OrganizationMembership :  IEquatable<OrganizationMembership>, IValidatableObject
    {
        ...
        public OrganizationMembership(string id = default(string), bool isDefault = default(bool), string name = default(string), string role = default(string))
        {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for OrganizationMembership and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isDefault == null)
            {
                throw new InvalidDataException("isDefault is a required property for OrganizationMembership and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for OrganizationMembership and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (role == null)
            {
                throw new InvalidDataException("role is a required property for OrganizationMembership and cannot be null");
            }
            else
            {
                this.Role = role;
