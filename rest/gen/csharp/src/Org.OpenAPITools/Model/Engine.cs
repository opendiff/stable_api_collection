...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Engine :  IEquatable<Engine>, IValidatableObject
    {
        ...
        public Engine(string description = default(string), string id = default(string), string name = default(string), TypeEnum type = default(TypeEnum))
        {
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for Engine and cannot be null");
            }
            else
            {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Engine and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Engine and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Engine and cannot be null");
            }
            else
            {
                this.Type = type;
