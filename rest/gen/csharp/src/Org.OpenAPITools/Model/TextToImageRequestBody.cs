...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TextToImageRequestBody :  IEquatable<TextToImageRequestBody>, IValidatableObject
    {
        ...
        public TextToImageRequestBody(decimal cfgScale = 7M, ClipGuidancePresetEnum? clipGuidancePreset = ClipGuidancePresetEnum.NONE, int height = 512, SamplerEnum? sampler = default(SamplerEnum?), int samples = 1, int seed = default(int), int steps = 50, List<TextPrompt> textPrompts = default(List<TextPrompt>), int width = 512)
        {
            ...
            if (textPrompts == null)
            {
                throw new InvalidDataException("textPrompts is a required property for TextToImageRequestBody and cannot be null");
            }
            else
            {
            ...
            // use default value if no "cfgScale" provided
            if (cfgScale == null)
            {
                this.CfgScale = 7M;
            }
            ...
            // use default value if no "clipGuidancePreset" provided
            if (clipGuidancePreset == null)
            {
                this.ClipGuidancePreset = ClipGuidancePresetEnum.NONE;
            }
            else
            {
            ...
            // use default value if no "samples" provided
            if (samples == null)
            {
                this.Samples = 1;
            }
            ...
            this.Seed = seed;
            // use default value if no "steps" provided
            if (steps == null)
            {
                this.Steps = 50;
            }
        ...
        /// </summary>
        [DataMember(Name="text_prompts", EmitDefaultValue=true)]
