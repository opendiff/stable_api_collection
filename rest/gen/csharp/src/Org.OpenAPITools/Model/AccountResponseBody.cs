...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class AccountResponseBody :  IEquatable<AccountResponseBody>, IValidatableObject
    {
        ...
        public AccountResponseBody(string email = default(string), string id = default(string), List<OrganizationMembership> organizations = default(List<OrganizationMembership>), string profilePicture = default(string))
        {
            ...
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for AccountResponseBody and cannot be null");
            }
            else
            {
                this.Email = email;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AccountResponseBody and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("organizations is a required property for AccountResponseBody and cannot be null");
            }
            else
            {
