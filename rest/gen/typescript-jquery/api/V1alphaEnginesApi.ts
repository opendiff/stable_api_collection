...
export class V1alphaEnginesApi {
     ...
     */
    public v1alphaEnginesListEngines(organization?: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.ListEnginesResponseBody;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/v1alpha/engines/list';
        ...
        $.ajax(requestOptions).then(
            (data: models.ListEnginesResponseBody, textStatus: string, jqXHR: JQueryXHR) =>
