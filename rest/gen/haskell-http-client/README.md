## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Stability.ai REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Stability.ai REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Stability.aiREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | stability.ai-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | aiRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | aiRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Stability.aiREST.Client    | use the "dispatch" functions to send requests       |
| Stability.aiREST.Core      | core functions, config and request types            |
| Stability.aiREST.API       | construct api requests                              |
| Stability.aiREST.Model     | describes api models                                |
| Stability.aiREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Stability.aiREST.ModelLens | lenses for model fields                             |
| Stability.aiREST.Logging   | logging functions and utils                         |
