...
module Stability.aiREST.Core where
...
-- |
data aiRESTConfig = aiRESTConfig
...
-- | display the config
instance P.Show aiRESTConfig where
  show c =
    T.printf
...
-- | constructs a default aiRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"stability.ai-rest/0.1.0.0"@
--
newConfig :: IO aiRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ aiRESTConfig
        { configHost = "https://api.stability.ai"
        , configUserAgent = "stability.ai-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => aiRESTConfig -> auth -> aiRESTConfig
addAuthMethod config@aiRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: aiRESTConfig -> IO aiRESTConfig
...
withStderrLogging :: aiRESTConfig -> IO aiRESTConfig
...
withNoLogging :: aiRESTConfig -> aiRESTConfig
...
data aiRESTRequest req contentType res accept = aiRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of aiRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of aiRESTRequest
  , rParams   :: Params -- ^ params of aiRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (aiRESTRequest req contentType res accept) NH.Method
rMethodL f aiRESTRequest{..} = (\rMethod -> aiRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (aiRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f aiRESTRequest{..} = (\rUrlPath -> aiRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (aiRESTRequest req contentType res accept) Params
rParamsL f aiRESTRequest{..} = (\rParams -> aiRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (aiRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f aiRESTRequest{..} = (\rAuthTypes -> aiRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => aiRESTRequest req contentType res accept -> param -> aiRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: aiRESTRequest req contentType res accept -> param -> aiRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: aiRESTRequest req contentType res accept -> param -> aiRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
_mkRequest :: NH.Method -- ^ Method
          ...
          -> aiRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = aiRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     aiRESTRequest req contentType res accept
  -> [NH.Header]
  -> aiRESTRequest req contentType res accept
...
removeHeader :: aiRESTRequest req contentType res accept -> [NH.HeaderName] -> aiRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => aiRESTRequest req contentType res accept -> aiRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => aiRESTRequest req contentType res accept -> aiRESTRequest req contentType res accept
...
addForm :: aiRESTRequest req contentType res accept -> WH.Form -> aiRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: aiRESTRequest req contentType res accept -> NH.Part -> aiRESTRequest req contentType res accept
...
_setBodyBS :: aiRESTRequest req contentType res accept -> B.ByteString -> aiRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: aiRESTRequest req contentType res accept -> BL.ByteString -> aiRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => aiRESTRequest req contentType res accept -> P.Proxy authMethod -> aiRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> aiRESTRequest req contentType res accept
    -> IO (aiRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> aiRESTConfig
  -> IO (aiRESTRequest req contentType res accept)
_applyAuthMethods req config@(aiRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
