...
export class V1alphaUserService {
     ...
     */
    public v1alphaUserAccount(): Observable<AxiosResponse<AccountResponseBody>>;
    public v1alphaUserAccount(): Observable<any> {
        ...
        return this.httpClient.get<AccountResponseBody>(`${this.basePath}/v1alpha/user/account`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v1alphaUserBalance(organization?: string, ): Observable<AxiosResponse<BalanceResponseBody>>;
    public v1alphaUserBalance(organization?: string, ): Observable<any> {
        ...
        return this.httpClient.get<BalanceResponseBody>(`${this.basePath}/v1alpha/user/balance`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers
            }
