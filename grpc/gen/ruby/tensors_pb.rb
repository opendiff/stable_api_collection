...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("tensors.proto", :syntax => :proto3) do
    add_message "tensors.Tensor" do
      optional :dtype, :enum, 1, "tensors.Dtype", json_name: "dtype"
      repeated :shape, :int64, 2, json_name: "shape"
      optional :data, :bytes, 3, json_name: "data"
      proto3_optional :attr_type, :enum, 4, "tensors.AttributeType", json_name: "attrType"
    end
    add_message "tensors.Attribute" do
      optional :name, :string, 1, json_name: "name"
      oneof :value do
        optional :module, :message, 3, "tensors.Module", json_name: "module"
        optional :tensor, :message, 4, "tensors.Tensor", json_name: "tensor"
        optional :string, :string, 5, json_name: "string"
        optional :int64, :int64, 6, json_name: "int64"
        optional :float, :float, 7, json_name: "float"
        optional :bool, :bool, 8, json_name: "bool"
      end
    end
    add_message "tensors.Module" do
      optional :name, :string, 1, json_name: "name"
      repeated :names, :string, 2, json_name: "names"
      repeated :attributes, :message, 3, "tensors.Attribute", json_name: "attributes"
    end
