...
enum Gooseai_FinishReason: SwiftProtobuf.Enum {
...
extension Gooseai_FinishReason: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_FinishReason] = [
    .null,
    .length,
    .stop,
    .error,
...
enum Gooseai_ArtifactType: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case artifactNone // = 0
...
extension Gooseai_ArtifactType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_ArtifactType] = [
    .artifactNone,
    .artifactImage,
    .artifactVideo,
    .artifactText,
...
enum Gooseai_MaskedAreaInit: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case zero // = 0
  case random // = 1
  case original // = 2
...
extension Gooseai_MaskedAreaInit: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_MaskedAreaInit] = [
    .zero,
    .random,
    .original,
  ]
...
enum Gooseai_WeightMethod: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case textEncoder // = 0
...
extension Gooseai_WeightMethod: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_WeightMethod] = [
    .textEncoder,
    .crossAttention,
  ]
}
...
enum Gooseai_DiffusionSampler: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case samplerDdim // = 0
  case samplerDdpm // = 1
...
extension Gooseai_DiffusionSampler: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_DiffusionSampler] = [
    .samplerDdim,
    .samplerDdpm,
    .samplerKEuler,
...
enum Gooseai_Upscaler: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case rgb // = 0
  case gfpgan // = 1
  case esrgan // = 2
...
extension Gooseai_Upscaler: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_Upscaler] = [
    .rgb,
    .gfpgan,
    .esrgan,
  ]
...
enum Gooseai_GuidancePreset: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case none // = 0
  case simple // = 1
  case fastBlue // = 2
...
extension Gooseai_GuidancePreset: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_GuidancePreset] = [
    .none,
    .simple,
    .fastBlue,
    .fastGreen,
...
enum Gooseai_ModelArchitecture: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case none // = 0
  case clipVit // = 1
  case clipResnet // = 2
...
extension Gooseai_ModelArchitecture: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_ModelArchitecture] = [
    .none,
    .clipVit,
    .clipResnet,
    .ldm,
...
enum Gooseai_Action: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case passthrough // = 0
...
extension Gooseai_Action: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_Action] = [
    .passthrough,
    .regenerateDuplicate,
    .regenerate,
    .obfuscateDuplicate,
...
enum Gooseai_ClassifierMode: SwiftProtobuf.Enum {
  typealias RawValue = Int
...
extension Gooseai_ClassifierMode: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_ClassifierMode] = [
    .clsfrModeZeroshot,
    .clsfrModeMulticlass,
  ]
}
...
enum Gooseai_AssetAction: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case assetPut // = 0
  case assetGet // = 1
  case assetDelete // = 2
...
extension Gooseai_AssetAction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_AssetAction] = [
    .assetPut,
    .assetGet,
    .assetDelete,
  ]
...
enum Gooseai_AssetUse: SwiftProtobuf.Enum {
  typealias RawValue = Int
...
extension Gooseai_AssetUse: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_AssetUse] = [
    .undefined,
    .input,
    .output,
    .intermediate,
...
enum Gooseai_StageAction: SwiftProtobuf.Enum {
  typealias RawValue = Int
  case pass // = 0
  case discard // = 1
  case `return` // = 2
...
extension Gooseai_StageAction: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Gooseai_StageAction] = [
    .pass,
    .discard,
    .return,
  ]
...
struct Gooseai_Tokens {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var tokens: [Gooseai_Token] = []
...
struct Gooseai_Artifact {
  ...
  var type: Gooseai_ArtifactType = .artifactNone
  ...
  var data: Gooseai_Artifact.OneOf_Data? = nil
  ...
  var tokens: Gooseai_Tokens {
    get {
      if case .tokens(let v)? = data {return v}
      return Gooseai_Tokens()
    }
    set {data = .tokens(newValue)}
  }

  var classifier: Gooseai_ClassifierParameters {
    get {
      if case .classifier(let v)? = data {return v}
      return Gooseai_ClassifierParameters()
    }
  ...
  var finishReason: Gooseai_FinishReason = .null
  ...
  enum OneOf_Data: Equatable {
    ...
    case text(String)
    /// Tokenized text data, e.g. GPT tokens
    case tokens(Gooseai_Tokens)
    case classifier(Gooseai_ClassifierParameters)
    /// torch.Tensor:
    case tensor(Tensors_Tensor)

  #if !swift(>=4.1)
    static func ==(lhs: Gooseai_Artifact.OneOf_Data, rhs: Gooseai_Artifact.OneOf_Data) -> Bool {
...
struct Gooseai_PromptParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Gooseai_Prompt {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var parameters: Gooseai_PromptParameters {
    get {return _parameters ?? Gooseai_PromptParameters()}
  ...
  var prompt: Gooseai_Prompt.OneOf_Prompt? = nil
  ...
  var artifact: Gooseai_Artifact {
    get {
      if case .artifact(let v)? = prompt {return v}
      return Gooseai_Artifact()
    }
  ...
  enum OneOf_Prompt: Equatable {
    case text(String)
    case tokens(Gooseai_Tokens)
    case artifact(Gooseai_Artifact)

  #if !swift(>=4.1)
    static func ==(lhs: Gooseai_Prompt.OneOf_Prompt, rhs: Gooseai_Prompt.OneOf_Prompt) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
  ...
  fileprivate var _parameters: Gooseai_PromptParameters? = nil
}

/// Parameters that affect the behavior of the sampler, typically used for CFG.
struct Gooseai_SamplerParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// initialization.
struct Gooseai_ConditionerParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var conditioner: Gooseai_Model {
    get {return _conditioner ?? Gooseai_Model()}
  ...
  fileprivate var _conditioner: Gooseai_Model? = nil
}

/// When does this schedule definition apply?
struct Gooseai_ScheduleParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Gooseai_StepParameter {
  ...
  var sampler: Gooseai_SamplerParameters {
    get {return _sampler ?? Gooseai_SamplerParameters()}
  ...
  var schedule: Gooseai_ScheduleParameters {
    get {return _schedule ?? Gooseai_ScheduleParameters()}
  ...
  var guidance: Gooseai_GuidanceParameters {
    get {return _guidance ?? Gooseai_GuidanceParameters()}
  ...
  fileprivate var _sampler: Gooseai_SamplerParameters? = nil
  fileprivate var _schedule: Gooseai_ScheduleParameters? = nil
  fileprivate var _guidance: Gooseai_GuidanceParameters? = nil
}

struct Gooseai_Model {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var architecture: Gooseai_ModelArchitecture = .none
...
struct Gooseai_CutoutParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Nested cutouts, unsupported
  var cutouts: [Gooseai_CutoutParameters] = []
...
/// current run.
struct Gooseai_GuidanceScheduleParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// of the models.
struct Gooseai_GuidanceInstanceParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// models to use for this set
  var models: [Gooseai_Model] {
  ...
  var schedule: [Gooseai_GuidanceScheduleParameters] {
  ...
  /// cutout parameters
  var cutouts: Gooseai_CutoutParameters {
    get {return _storage._cutouts ?? Gooseai_CutoutParameters()}
  ...
  var prompt: Gooseai_Prompt {
    get {return _storage._prompt ?? Gooseai_Prompt()}
...
struct Gooseai_GuidanceParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// base preset for guidance
  var guidancePreset: Gooseai_GuidancePreset = .none

  /// guidance instances
  var instances: [Gooseai_GuidanceInstanceParameters] = []
...
struct Gooseai_TransformType {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var type: Gooseai_TransformType.OneOf_Type? = nil

  var diffusion: Gooseai_DiffusionSampler {
    get {
  ...
  enum OneOf_Type: Equatable {
    case diffusion(Gooseai_DiffusionSampler)
    case upscaler(Gooseai_Upscaler)

  #if !swift(>=4.1)
    static func ==(lhs: Gooseai_TransformType.OneOf_Type, rhs: Gooseai_TransformType.OneOf_Type) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
struct Gooseai_ImageParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var transform: Gooseai_TransformType {
    get {return _transform ?? Gooseai_TransformType()}
  ...
  var parameters: [Gooseai_StepParameter] = []

  /// defaults to MASKED_AREA_INIT_ZERO 
  var maskedAreaInit: Gooseai_MaskedAreaInit {
  ...
  var weightMethod: Gooseai_WeightMethod {
  ...
  fileprivate var _transform: Gooseai_TransformType? = nil
  fileprivate var _maskedAreaInit: Gooseai_MaskedAreaInit? = nil
  fileprivate var _weightMethod: Gooseai_WeightMethod? = nil
  fileprivate var _quantize: Bool? = nil
}

struct Gooseai_ClassifierConcept {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Gooseai_ClassifierCategory {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var concepts: [Gooseai_ClassifierConcept] = []
  ...
  var classifierMode: Gooseai_ClassifierMode {
  ...
  fileprivate var _action: Gooseai_Action? = nil
  fileprivate var _classifierMode: Gooseai_ClassifierMode? = nil
}

struct Gooseai_ClassifierParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var categories: [Gooseai_ClassifierCategory] = []

  var exceeds: [Gooseai_ClassifierCategory] = []

  var realizedAction: Gooseai_Action {
  ...
  fileprivate var _realizedAction: Gooseai_Action? = nil
}

struct Gooseai_AssetParameters {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var action: Gooseai_AssetAction = .assetPut

  var projectID: String = String()

  var use: Gooseai_AssetUse = .undefined
...
struct Gooseai_Answer {
  ...
  var meta: Gooseai_AnswerMeta {
    get {return _meta ?? Gooseai_AnswerMeta()}
    set {_meta = newValue}
  }
  ...
  var artifacts: [Gooseai_Artifact] = []

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _meta: Gooseai_AnswerMeta? = nil
}
...
struct Gooseai_Request {
  ...
  var requestedType: Gooseai_ArtifactType {
  ...
  var image: Gooseai_ImageParameters {
    get {
      if case .image(let v)? = _storage._params {return v}
      return Gooseai_ImageParameters()
    }
  ...
  var asset: Gooseai_AssetParameters {
    get {
      if case .asset(let v)? = _storage._params {return v}
      return Gooseai_AssetParameters()
    }
    set {_uniqueStorage()._params = .asset(newValue)}
  }

  var conditioner: Gooseai_ConditionerParameters {
    get {return _storage._conditioner ?? Gooseai_ConditionerParameters()}
  ...
  enum OneOf_Params: Equatable {
    case image(Gooseai_ImageParameters)
    case classifier(Gooseai_ClassifierParameters)
    case asset(Gooseai_AssetParameters)

  #if !swift(>=4.1)
    static func ==(lhs: Gooseai_Request.OneOf_Params, rhs: Gooseai_Request.OneOf_Params) -> Bool {
      // The use of inline closures is to circumvent an issue where the compiler
      // allocates stack space for every case branch when no optimizations are
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch (lhs, rhs) {
...
struct Gooseai_OnStatus {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var reason: [Gooseai_FinishReason] = []
  ...
  var action: [Gooseai_StageAction] = []
...
struct Gooseai_Stage {
  ...
  var request: Gooseai_Request {
    get {return _request ?? Gooseai_Request()}
  ...
  var onStatus: [Gooseai_OnStatus] = []

  var unknownFields = SwiftProtobuf.UnknownStorage()

  init() {}

  fileprivate var _request: Gooseai_Request? = nil
}

struct Gooseai_ChainRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Gooseai_FinishReason: @unchecked Sendable {}
extension Gooseai_ArtifactType: @unchecked Sendable {}
extension Gooseai_MaskedAreaInit: @unchecked Sendable {}
extension Gooseai_WeightMethod: @unchecked Sendable {}
extension Gooseai_DiffusionSampler: @unchecked Sendable {}
extension Gooseai_Upscaler: @unchecked Sendable {}
extension Gooseai_GuidancePreset: @unchecked Sendable {}
extension Gooseai_ModelArchitecture: @unchecked Sendable {}
extension Gooseai_Action: @unchecked Sendable {}
extension Gooseai_ClassifierMode: @unchecked Sendable {}
extension Gooseai_AssetAction: @unchecked Sendable {}
extension Gooseai_AssetUse: @unchecked Sendable {}
extension Gooseai_StageAction: @unchecked Sendable {}
extension Gooseai_Token: @unchecked Sendable {}
extension Gooseai_Tokens: @unchecked Sendable {}
extension Gooseai_Artifact: @unchecked Sendable {}
extension Gooseai_Artifact.OneOf_Data: @unchecked Sendable {}
extension Gooseai_PromptParameters: @unchecked Sendable {}
extension Gooseai_Prompt: @unchecked Sendable {}
extension Gooseai_Prompt.OneOf_Prompt: @unchecked Sendable {}
extension Gooseai_SamplerParameters: @unchecked Sendable {}
extension Gooseai_ConditionerParameters: @unchecked Sendable {}
extension Gooseai_ScheduleParameters: @unchecked Sendable {}
extension Gooseai_StepParameter: @unchecked Sendable {}
extension Gooseai_Model: @unchecked Sendable {}
extension Gooseai_CutoutParameters: @unchecked Sendable {}
extension Gooseai_GuidanceScheduleParameters: @unchecked Sendable {}
extension Gooseai_GuidanceInstanceParameters: @unchecked Sendable {}
extension Gooseai_GuidanceParameters: @unchecked Sendable {}
extension Gooseai_TransformType: @unchecked Sendable {}
extension Gooseai_TransformType.OneOf_Type: @unchecked Sendable {}
extension Gooseai_ImageParameters: @unchecked Sendable {}
extension Gooseai_ClassifierConcept: @unchecked Sendable {}
extension Gooseai_ClassifierCategory: @unchecked Sendable {}
extension Gooseai_ClassifierParameters: @unchecked Sendable {}
extension Gooseai_AssetParameters: @unchecked Sendable {}
extension Gooseai_AnswerMeta: @unchecked Sendable {}
extension Gooseai_Answer: @unchecked Sendable {}
extension Gooseai_Request: @unchecked Sendable {}
extension Gooseai_Request.OneOf_Params: @unchecked Sendable {}
extension Gooseai_OnStatus: @unchecked Sendable {}
extension Gooseai_Stage: @unchecked Sendable {}
extension Gooseai_ChainRequest: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "gooseai"

extension Gooseai_FinishReason: SwiftProtobuf._ProtoNameProviding {
...
extension Gooseai_ArtifactType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_MaskedAreaInit: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_WeightMethod: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_DiffusionSampler: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_Upscaler: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_GuidancePreset: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_ModelArchitecture: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_Action: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_ClassifierMode: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_AssetAction: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_AssetUse: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_StageAction: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Gooseai_Token: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_Token, rhs: Gooseai_Token) -> Bool {
...
extension Gooseai_Tokens: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_Tokens, rhs: Gooseai_Tokens) -> Bool {
...
extension Gooseai_Artifact: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 11: try {
        var v: Gooseai_ClassifierParameters?
        var hadOneofValue = false
        if let current = self.data {
          hadOneofValue = true
  ...
  static func ==(lhs: Gooseai_Artifact, rhs: Gooseai_Artifact) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Gooseai_PromptParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_PromptParameters, rhs: Gooseai_PromptParameters) -> Bool {
...
extension Gooseai_Prompt: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_Prompt, rhs: Gooseai_Prompt) -> Bool {
...
extension Gooseai_SamplerParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_SamplerParameters, rhs: Gooseai_SamplerParameters) -> Bool {
...
extension Gooseai_ConditionerParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_ConditionerParameters, rhs: Gooseai_ConditionerParameters) -> Bool {
...
extension Gooseai_ScheduleParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_ScheduleParameters, rhs: Gooseai_ScheduleParameters) -> Bool {
...
extension Gooseai_StepParameter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_StepParameter, rhs: Gooseai_StepParameter) -> Bool {
...
extension Gooseai_Model: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_Model, rhs: Gooseai_Model) -> Bool {
...
extension Gooseai_CutoutParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_CutoutParameters, rhs: Gooseai_CutoutParameters) -> Bool {
...
extension Gooseai_GuidanceScheduleParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_GuidanceScheduleParameters, rhs: Gooseai_GuidanceScheduleParameters) -> Bool {
...
extension Gooseai_GuidanceInstanceParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _models: [Gooseai_Model] = []
    var _guidanceStrength: Float? = nil
    var _schedule: [Gooseai_GuidanceScheduleParameters] = []
    var _cutouts: Gooseai_CutoutParameters? = nil
    var _prompt: Gooseai_Prompt? = nil
  ...
  static func ==(lhs: Gooseai_GuidanceInstanceParameters, rhs: Gooseai_GuidanceInstanceParameters) -> Bool {
...
extension Gooseai_GuidanceParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_GuidanceParameters, rhs: Gooseai_GuidanceParameters) -> Bool {
...
extension Gooseai_TransformType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try {
        var v: Gooseai_DiffusionSampler?
  ...
  static func ==(lhs: Gooseai_TransformType, rhs: Gooseai_TransformType) -> Bool {
    if lhs.type != rhs.type {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Gooseai_ImageParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_ImageParameters, rhs: Gooseai_ImageParameters) -> Bool {
...
extension Gooseai_ClassifierConcept: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_ClassifierConcept, rhs: Gooseai_ClassifierConcept) -> Bool {
...
extension Gooseai_ClassifierCategory: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_ClassifierCategory, rhs: Gooseai_ClassifierCategory) -> Bool {
...
extension Gooseai_ClassifierParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_ClassifierParameters, rhs: Gooseai_ClassifierParameters) -> Bool {
...
extension Gooseai_AssetParameters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_AssetParameters, rhs: Gooseai_AssetParameters) -> Bool {
...
extension Gooseai_AnswerMeta: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_AnswerMeta, rhs: Gooseai_AnswerMeta) -> Bool {
...
extension Gooseai_Answer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_Answer, rhs: Gooseai_Answer) -> Bool {
...
extension Gooseai_Request: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _requestedType: Gooseai_ArtifactType = .artifactNone
    var _prompt: [Gooseai_Prompt] = []
    var _params: Gooseai_Request.OneOf_Params?
    var _conditioner: Gooseai_ConditionerParameters? = nil
  ...
  static func ==(lhs: Gooseai_Request, rhs: Gooseai_Request) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        let _storage = _args.0
        let rhs_storage = _args.1
...
extension Gooseai_OnStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_OnStatus, rhs: Gooseai_OnStatus) -> Bool {
...
extension Gooseai_Stage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_Stage, rhs: Gooseai_Stage) -> Bool {
    if lhs.id != rhs.id {return false}
...
extension Gooseai_ChainRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Gooseai_ChainRequest, rhs: Gooseai_ChainRequest) -> Bool {
    if lhs.requestID != rhs.requestID {return false}
